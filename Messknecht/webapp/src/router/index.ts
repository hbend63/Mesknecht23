...
import ADCAdminView from '@/views/ADCAdminView.vue';
import InfluxdbAdminView from '@/views/InfluxdbAdminView.vue';
...
const router = createRouter({
    ...
    },
    {
        path: '/settings/adc',
        name: 'ADC Settings',
        component: ADCAdminView
    },
    {
        path: '/settings/influx',
        name: 'Influxdb Settings',
        component: InfluxdbAdminView
    },
