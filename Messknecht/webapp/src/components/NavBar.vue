                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            ...
                            <li>
                                <router-link @click="onClick" class="dropdown-item" to="/settings/adc">{{ $t('menu.ADCSettings') }}</router-link>
                            </li>

                            <li>
                                <router-link @click="onClick" class="dropdown-item" to="/settings/influx">{{ $t('menu.InfluxdbSettings') }}</router-link>
                            </li>
